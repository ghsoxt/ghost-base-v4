...
vSERVER = Tunnel.getInterface("alien_login")

local cupom = "Alien RP | 20%OFF"
local site = "store.cidadeAlien.com"
local qrcode = "https://cdn.discordapp.com/attachments/818021764856545280/1016936728268898304/Alienrp.png"
