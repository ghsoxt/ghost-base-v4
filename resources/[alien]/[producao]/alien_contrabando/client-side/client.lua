...
vSERVER = Tunnel.getInterface("alien_contrabando")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	if data == "fabricar-1" then
		TriggerServerEvent("alien_contrabando:weaponfactory","colete")
		
	elseif data == "fabricar-2" then
		TriggerServerEvent("alien_contrabando:weaponfactory","algema")
		
	elseif data == "fabricar-3" then
		TriggerServerEvent("alien_contrabando:weaponfactory","pendrive")
		
	elseif data == "fabricar-4" then
		TriggerServerEvent("alien_contrabando:weaponfactory","capuz")

	elseif data == "fabricar-5" then
		TriggerServerEvent("alien_contrabando:weaponfactory","cartao")
...
local factory = {
	{['x'] = -2647.09, ['y'] = 1694.49, ['z'] = 138.65 }, --- CAMORRA
	{['x'] = -563.29, ['y'] = 286.93, ['z'] = 85.38 }, --- TEQUILA
}
