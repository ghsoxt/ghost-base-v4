...
vSERVER = Tunnel.getInterface("alien_lsd")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	if data == "fabricar-lsd" then
		TriggerServerEvent("alien_lsd:weaponfactory","lsd")
		
	elseif data == "fabricar-lsdd" then
		TriggerServerEvent("alien_lsd:weaponfactory","lsdd")
		
	elseif data == "fabricar-embalalsd" then
		TriggerServerEvent("alien_lsd:weaponfactory","embala1")
		
	elseif data == "fabricar-embalalsdd" then
		TriggerServerEvent("alien_lsd:weaponfactory","embala2")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local factory = {
	{ ['x'] = -145.97, ['y'] = 6301.29, ['z'] = 25.07 }, --- Canada
	{ ['x'] = -1521.63, ['y'] = 4767.73, ['z'] = 63.71 }, --- Egito 
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ MENU ]-------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
