...
vSERVER = Tunnel.getInterface("alien_cocaina")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	if data == "fabricar-coca" then
		TriggerServerEvent("alien_cocaina:weaponfactory","coca")
		
	elseif data == "fabricar-cocaa" then
		TriggerServerEvent("alien_cocaina:weaponfactory","cocaa")
		
	elseif data == "fabricar-embalacoca" then
		TriggerServerEvent("alien_cocaina:weaponfactory","embala1")
		
	elseif data == "fabricar-embalacocaa" then
		TriggerServerEvent("alien_cocaina:weaponfactory","embala2")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local factory = {
	{ ['x'] = 1594.67, ['y'] = -2107.62, ['z'] = 91.88 }, -- Colombia
	{ ['x'] = 1693.62, ['y'] = -64.08, ['z'] = 174.96 }, --- França
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ MENU ]-------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
