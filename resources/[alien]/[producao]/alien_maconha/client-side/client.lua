...
vSERVER = Tunnel.getInterface("alien_maconha")
...
RegisterNUICallback("ButtonClick",function(data,cb)
	...
	if data == "fabricar-maconha" then
		TriggerServerEvent("alien_maconha:weaponfactory","maconha")
		
	elseif data == "fabricar-maconhaa" then
		TriggerServerEvent("alien_maconha:weaponfactory","maconhaa")
		
	elseif data == "fabricar-embalamac" then
		TriggerServerEvent("alien_maconha:weaponfactory","embala1")
		
	elseif data == "fabricar-embalamaco" then
		TriggerServerEvent("alien_maconha:weaponfactory","embala2")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local factory = {
	{ ['x'] = 1251.06, ['y'] = -171.15, ['z'] = 90.73 }, --- GROTA 
	{ ['x'] = 1332.46, ['y'] = -680.48, ['z'] = 75.86 } --- TURQUIA
}
-----------------------------------------------------------------------------------------------------------------------------------------
--[ MENU ]-------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
