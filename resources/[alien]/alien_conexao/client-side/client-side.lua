...
RegisterNUICallback("lock",function(source ,cb) -- Callback quando a internet cai
    ...
    TriggerEvent('alien_conexao:close') -- Evento a ser disparado pra a alguns scripts para fechar a nui, como inventário e coisas do gênero! 
