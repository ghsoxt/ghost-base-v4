...
const updateDrag = () => {
    ...
    $('.use').droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://alien_inventario/useItem", JSON.stringify({
                item: itemData.key,
                type: itemData.type,
    ...
    $('.dropitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://alien_inventario/dropItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
    ...
    $('.takedropitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (ui.draggable.data('slot') == undefined) {
                $.post("http://alien_inventario/unEquip", JSON.stringify({
    ...
    $('.send').droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://alien_inventario/sendItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
    ...
    $('.putHomeitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            $.post("http://alien_inventario/storeHomeItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
            document.getElementById("amount").value = "";
    ...
    $('.takeHomeitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            $.post("http://alien_inventario/takeHomeItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
            document.getElementById("amount").value = "";
    ...
    $('.roubarItem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            if (acao == "ROUBAR") {
                $.post("http://alien_inventario/requestRoubar", JSON.stringify({
                    item: itemData.key,
                    amount: Number($("#amount").val())
                }))
                updateRevistar();
    ...
    $('.takechestitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            $.post("http://alien_inventario/takeItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
            document.getElementById("amount").value = "";
    ...
    $('.putchestitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            $.post("http://alien_inventario/storeItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
            document.getElementById("amount").value = "";
    ...
    $('.taketrunkchestitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            $.post("http://alien_inventario/takeTrunkItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
            document.getElementById("amount").value = "";
    ...
    $('.puttrunkchestitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (itemData.key === undefined) return;
            $.post("http://alien_inventario/storeTrunkItem", JSON.stringify({
                item: itemData.key,
                amount: Number($("#amount").val())
            }))
            document.getElementById("amount").value = "";
    ...
    $('.buyitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (ui.draggable.data('slot') == "COMPRAR") {
                $.post("http://alien_inventario/buyItem", JSON.stringify({
                    item: itemData.key,
                    amount: Number($("#amount").val()),
                    method: method,
                    shop: selectShop
    ...
    $('.sellitem').droppable({
        ...
        drop: function(event, ui) {
            ...
            if (ui.draggable.data('slot') == "VENDER") {
                $.post("http://alien_inventario/sellItem", JSON.stringify({
                    item: itemData.key,
                    amount: Number($("#amount").val()),
                    method: method,
                    shop: selectShop
    ...
    $('#bind1').droppable({
        ...
        drop: function(event, ui) {
            ...
            $.post("http://alien_inventario/bindItem", JSON.stringify({
                item: itemData.key,
                slot: "1"
            }))
...
const updateIdentity = () => {
    $.post("http://alien_inventario/requestIdentity", JSON.stringify({}), (data) => {
        $(".myName").html(`
...
const updateMochila = () => {
    ...
    $.post("http://alien_inventario/requestMochila", JSON.stringify({}), (data) => {
...
const updateChest = () => {
    ...
    $.post("http://alien_inventario/requestChest", JSON.stringify({}), (data) => {
...
const updateHomeChest = () => {
    document.getElementById("amount").value = "";
    $.post("http://alien_inventario/requestHomeChest", JSON.stringify({}), (data) => {
...
const updateTrunkChest = () => {
    document.getElementById("amount").value = "";
    $.post("http://alien_inventario/requestTrunkChest", JSON.stringify({}), (data) => {
...
const updateShop = () => {
    document.getElementById("amount").value = "";
    $.post("http://alien_inventario/requestShop", JSON.stringify({ shop: selectShop }), (data) => {
        weightLeft = data.peso;
        maxWeightLeft = data.maxpeso;
        $('#invleft').html("");
        $('#invright').html("");
...
const updateRevistar = () => {
    document.getElementById("amount").value = "";
    $.post("http://alien_inventario/requestRevistar", JSON.stringify({}), (data) => {
        $('#invleft').html("");
        $('#invright').html("");
