...
itens.usaveis = {
    ...
    ['skin1'] = function(source,user_id)
        TriggerClientEvent("transformToTravesti", source)
    end,
    ...
    ['lockpick'] = function(source,user_id) 
        ...
        if vRP.getInventoryItemAmount(user_id,"lockpick") >= 1 and vehicle then
                ...
                if taskre then
                    ...
                    TriggerClientEvent("progress",source,30000,"Passando Lockpick")
    ...
    ['masterpick'] = function(source,user_id) 
        ...
        if vRP.getInventoryItemAmount(user_id,"masterpick") >= 1 and vehicle then
                ...
                -- if taskre then
                    ...
                    TriggerClientEvent('cancelando',source,true)
                    vRPclient._playAnim(source,false,{{"amb@prop_human_parking_meter@female@idle_a","idle_a_female"}},true)
                    TriggerClientEvent("progress",source,30000,"Passando Masterpick")
