...
vRPNserver = Tunnel.getInterface("alien_inventario")

func = {}
Proxy.addInterface("alien_inventario",func)
Tunnel.bindInterface("alien_inventario",func)
...
function transformToTravesti()
    local playerPed = PlayerPedId()
    local modelHash = GetHashKey(travesti1.model)
...
RegisterNetEvent("transformToTravesti")
AddEventHandler("transformToTravesti", transformToTravesti)