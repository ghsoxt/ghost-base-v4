...
RegisterNetEvent("alien-character:normalSpawn")
RegisterNetEvent("alien-character:characterCreate")

local doStatus = -1
local cam = nil


AddEventHandler("alien-character:normalSpawn",function(firstspawn)
	if firstspawn then
		doStatus = 2
		TriggerEvent("hudActived",true)
	else
		TriggerEvent("vrp:ToogleLoginMenu",true)
	end
end)
...
AddEventHandler("alien-character:characterCreate",function()
...
function refreshDefaultCharacter()
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
        ...
        SetPedComponentVariation(PlayerPedId(),4,32,0,2)
        SetPedComponentVariation(PlayerPedId(),6,19,9,2)
        SetPedComponentVariation(PlayerPedId(),7,15,0,2)
        SetPedComponentVariation(PlayerPedId(),8,15,0,2)
        SetPedComponentVariation(PlayerPedId(),9,0,1,2)
        SetPedComponentVariation(PlayerPedId(),11,4,0,2)
        SetPedPropIndex(PlayerPedId(),6,5,0)
		...
		SetPedComponentVariation(PlayerPedId(),4,5,6,2)
		SetPedComponentVariation(PlayerPedId(),5,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),6,116,0,2)
		...
		SetPedComponentVariation(PlayerPedId(),11,203,3,2)
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(),-490.9,-695.09,33.22,true,true,true)
	SetEntityHeading(PlayerPedId(),f(359.91))
