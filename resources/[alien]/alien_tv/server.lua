...
RegisterServerEvent('alien_tv:add')
AddEventHandler('alien_tv:add', function(url, object, coords, scale, offset)
    ...
    TriggerClientEvent('alien_tv:update', -1, tosend)
end)

RegisterServerEvent('alien_tv:fetch')
AddEventHandler('alien_tv:fetch', function()
    local tosend = {}
    ...
    TriggerClientEvent('alien_tv:update', source, tosend)
end)

RegisterServerEvent('alien_tv:setvolume')
AddEventHandler('alien_tv:setvolume', function(id, volume)
    if volume >= 0 and volume <= 10 then
        if data[id] then

            data[id]['Volume'] = volume

            TriggerClientEvent('alien_tv:updatevolume', -1, id, volume)

        end
    end
end)

RegisterServerEvent('alien_tv:destroy')
AddEventHandler('alien_tv:destroy', function(id)
    if data[id] then
        data[id] = nil
        TriggerClientEvent('alien_tv:delete', -1, id)
    end
end)