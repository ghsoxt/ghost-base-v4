...
-- ALGEMAR
--------------------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping('vrp_policia:algemarAlien', '[G] ALGEMAR', 'keyboard', 'G')

RegisterCommand("vrp_policia:algemarAlien",function(source,args,rawCommand)
...
-- CARREGAR
--------------------------------------------------------------------------------------------------------------------------------------------------
RegisterKeyMapping('vrp_policia:carregarAlien', '[H] CARREGAR', 'keyboard', 'H')

RegisterCommand("vrp_policia:carregarAlien",function(source,args,rawCommand)
	if not IsPedInAnyVehicle(PlayerPedId()) then 
