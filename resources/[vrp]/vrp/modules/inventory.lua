...
local inventario = Proxy.getInterface('alien_inventario')

local Tunnel = module("vrp","lib/Tunnel")
local arena = Tunnel.getInterface("alien_arena")

local webhookrevi = "---------------------1082554450167742575/Ngz-BpVmHRiqdIZw7nkuQ_r1rES5yQF22mXYWO-TISeBV_bXvA9BVQJv68amXoGVc6Jw"
...
function vRP.itemNameList(item)
	if item ~= nil then
		return exports['alien_inventario']:get_name_list(item)
	end
end

function vRP.itemIndexList(item)
	if item ~= nil then
		return exports['alien_inventario']:get_index_item(item)
	end
end

function vRP.itemTypeList(item)
	if item ~= nil then
		return exports['alien_inventario']:get_type_item(item)
	end
end

function vRP.itemBodyList(item)
	if item ~= nil then
		return exports['alien_inventario']:get_info_item(item)
	end
end

function vRP.getItemDefinition(idname)
	return exports['alien_inventario']:get_name_peso(idname)
end
...
function vRP.vehicleModel(model)
    return garage.getVehicleModelName(model)
end
...
local vehglobal = {
	...
	["cb500x"] = { ['name'] = "Honda CB500", ['price'] = 800000, ['tipo'] = "exclusive" },
	["hcbr17"] = { ['name'] = "Honda CBR17", ['price'] = 800000, ['tipo'] = "exclusive" },
	...
	["africat"] = { ['name'] = "Honda CRF 1000", ['price'] = 800000, ['tipo'] = "exclusive" },
	...
	["160chumbo"] = { ['name'] = "Cg 160", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["240sxhr"] = { ['name'] = "240SXHR", ['price'] = 800000, ['tipo'] = "exclusive" },  	
	[ "420x"] = { ['name'] = "420x", ['price'] = 800000, ['tipo'] = "exclusive" },      	
	["1500ghoul"]  = { ['name'] = "1500 Ghoul", ['price'] = 800000, ['tipo'] = "exclusive" },     
	[ "africa"]  = { ['name'] = "Honda Africa", ['price'] = 800000, ['tipo'] = "exclusive" },     
	["ahksv"]  = { ['name'] = "Lamborghini AHKSV  ", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["amels200"] = { ['name'] = "Yate", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["amggtc"] = { ['name'] = "Mercedes AMGGTC", ['price'] = 800000, ['tipo'] = "exclusive" },    	
	[ "babyr1250"]  = { ['name'] = "R12500 KID", ['price'] = 800000, ['tipo'] = "exclusive" },
	["auditt"]  = { ['name'] = "Audi TT", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["ar8lb"]  = { ['name'] = "Audi R8LB", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["babyamarokbr"]  = { ['name'] = "Amarok Kid", ['price'] = 800000, ['tipo'] = "exclusive" },     
	["bmwboltz"] = { ['name'] = "Bmw Boltz", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["bmwm1wb"]  = { ['name'] = "Bmw M1", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["c7"]  = { ['name'] = "Corvette C7", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["cad"]  = { ['name'] = "Ferrari FXXK Evo", ['price'] = 800000, ['tipo'] = "exclusive" },     	
	["cb1000r2013"]  = { ['name'] = "Honda CB1000R", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["cbb"] = { ['name'] = "Honda CBB", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["cbrr"] = { ['name'] = "Honda CBRR", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["bmwm3f80"] = { ['name'] = "Bmw M3", ['price'] = 800000, ['tipo'] = "exclusive" },      
	["bmwm8gte"] = { ['name'] = "Bmw M8 GTE", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["bmwm135i"] = { ['name'] = "Bmw 135I", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["brickade"] = { ['name'] = "Brickade", ['price'] = 800000, ['tipo'] = "exclusive" },   	
	["chillybin"] = { ['name'] = "Chillybin", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["declassbmw"] = { ['name'] = "Bmw Class", ['price'] = 800000, ['tipo'] = "exclusive" },      	
	[ "etrongt22"] = { ['name'] = "Audi Etrongt22", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["babyamarokbr"] = { ['name'] = "Amarok KID", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["evox"] = { ['name'] = "Lancer EVOX", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["fd"] = { ['name'] = "Mazda RX7", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["foxc8wb"] = { ['name'] = "Corvette C8", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["foxevos"] = { ['name'] = "Lamborghini EVOS", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["frauscher16"] = { ['name'] = "Yate 2", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["g7cross"] = { ['name'] = "Saveiro G7", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["gle53"] = { ['name'] = "Mercedes GLE53", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["golfp"] = { ['name'] = "Golf sportline", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["gt63samg"] = { ['name'] = "Mercedes GT63", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["gxa45"] = { ['name'] = "Mercedes A45", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["hcbr17"] = { ['name'] = "Honda CBR  2017", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["hornet2014"] = { ['name'] = "Hornet 2014", ['price'] = 800000, ['tipo'] = "exclusive" },         
	["jeepag"] = { ['name'] = "Jeep KID", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["jettagli"] = { ['name'] = "Volskvagem Jetta GLI", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["LBM4"] = { ['name'] = "BMW M4", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["lw458s"] = { ['name'] = "Ferrari 458S", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["lwgtr"] = { ['name'] = "Nissan Skyline GTR", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["lwgtr2"] = { ['name'] = "Nissan Skyline GTR 2", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["mansurus"] = { ['name'] = "urus Rebaixada", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["MG63PxxBK"] = { ['name'] = "Mercedes MG63P", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["mt09"] = { ['name'] = "MT 2009", ['price'] = 800000, ['tipo'] = "exclusive" },      	
	[ "nxchuteira"] = { ['name'] = "Chuteira", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["ocnetrongt"] = { ['name'] = "Audi ocnetrongt", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["opalass"] = { ['name'] = "Opala SS", ['price'] = 800000, ['tipo'] = "exclusive" },        
	[ "p90d"] = { ['name'] = "Tesla P90D", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["paratisom"] = { ['name'] = "Volskvagem Parati", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["polestar1"] = { ['name'] = "Polestar", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["porscheag"] = { ['name'] = "Porsche KID", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["pounder2" ] = { ['name'] = "Pounder2", ['price'] = 800000, ['tipo'] = "exclusive" },     	
	[ "r34g"] = { ['name'] = "Nissan Skyline R34G", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["ram2500"] = { ['name'] = "Dodge Ram2500", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["rangeroverstartech"] = { ['name'] = "Ranger Rover", ['price'] = 800000, ['tipo'] = "exclusive" },         
	["RC350"] = { ['name'] = "Lexus RC350", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rimac"] = { ['name'] = "Rimac", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["rmodbentleygt"] = { ['name'] = "Bentley GT", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rmodbmwm8"] = { ['name'] = "Ferrari FXXK Evo", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rmodcharger69"] = { ['name'] = "Dodge Charger 69", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["rmodescort"] = { ['name'] = "Ford Escort", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["rmodf12tdf"] = { ['name'] = "Ferrari TDF", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["rmodg65"] = { ['name'] = "Mercedes G65", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["rmodgt63"] = { ['name'] = "Mercedes G63", ['price'] = 800000, ['tipo'] = "exclusive" },         
	["rmodgt63mini"] = { ['name'] = "Mercedes G63 KID", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rmodi8ks"] = { ['name'] = "Bmw I8KS", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["rmodlfa"] = { ['name'] = "Lexus Lfa", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rmodlp670"] = { ['name'] = "Lamborghini LP670", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["rmodm4gts"] = { ['name'] = "Bmw M4 GTS", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["rmodm5e34"] = { ['name'] = "Bmw M5E34", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rmodmonster"] = { ['name'] = "Monster ", ['price'] = 800000, ['tipo'] = "exclusive" },      
	["rmodmonstergt"] = { ['name'] = "Mercedes GT63 Monster", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["rmodmonsterr34"] = { ['name'] = "Nissan Skyline R34 Monster", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rmodp1gtr"] = { ['name'] = "Mclaren P1 GTR", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["rmodporsche918"] = { ['name'] = "Porsche 918", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["rmodrs7"] = { ['name'] = "Audi RS7", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["rmodsuprapandem"] = { ['name'] = "Supra Pandem", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["rmodtracktor"] = { ['name'] = "Trator", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["rmodtracktor2"] = { ['name'] = "Trator 2", ['price'] = 800000, ['tipo'] = "exclusive" },      	
	["rrs08"] = { ['name'] = "Range Rover 2008", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["rs6c8"] = { ['name'] = "Audi RS6", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["s1hr"] = { ['name'] = "Audi S1HR", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["s10hc"] = { ['name'] = "Chevrolet S1-", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["s14hachi"] = { ['name'] = "Nissan Silvia S14", ['price'] = 800000, ['tipo'] = "exclusive" },       
	["s15varietta"] = { ['name'] = "Nissan Silvia S15", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["s1000docandidato"] = { ['name'] = "Bmw S100", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["skylinekid"] = { ['name'] = "Nissan Skyline R34 KID", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["sr1"] = { ['name'] = "Bmw SR1", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["tiger1200"] = { ['name'] = "Tiger 1200", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["titanh"] = { ['name'] = "Nissan Titanh", ['price'] = 800000, ['tipo'] = "exclusive" },      	
	["topcar911"] = { ['name'] = "Porsche 911", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["trailblazer"] = { ['name'] = "Trail Blazer", ['price'] = 800000, ['tipo'] = "exclusive" },         
	["up"] = { ['name'] = "Volskvagem UP", ['price'] = 800000, ['tipo'] = "exclusive" },         	
	["v4sf"] = { ['name'] = "Ducati V4SF", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["velociraptor"] = { ['name'] = "Ford Velociraptor", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["vette"] = { ['name'] = "Corvette", ['price'] = 800000, ['tipo'] = "exclusive" },      	
	["wrx"] = { ['name'] = "Subaru WRX", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["xc90r"] = { ['name'] = "Volvo XC90R", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["xt66"] = { ['name'] = "Xt66", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["xt660vip"] = { ['name'] = "Xt660 ", ['price'] = 800000, ['tipo'] = "exclusive" },        
	["xxxxx"] = { ['name'] = "Mercedes Monster", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["yacht3a"] = { ['name'] = "Yate 3", ['price'] = 800000, ['tipo'] = "exclusive" },        	
	["yamahar1"] = { ['name'] = "Yamaha R1", ['price'] = 800000, ['tipo'] = "exclusive" },      
	["z4bmw"]  = { ['name'] = "Bmw Z4", ['price'] = 800000, ['tipo'] = "exclusive" },       	
	["zx10"] = { ['name'] = "ZX10", ['price'] = 800000, ['tipo'] = "exclusive" },
	["silvia"] = { ['name'] = "Silvia", ['price'] = 800000, ['tipo'] = "exclusive" },
	["golfrebaixado"] = { ['name'] = "Golf Rebaixado", ['price'] = 800000, ['tipo'] = "exclusive" },
	
      	
	["polmav"] = { ['polmav'] = "Helicóptero Policia", ['price'] = 800000, ['tipo'] = "work" },        
	["vrdm1200"] = { ['name'] = "Ducati Policia ", ['price'] = 800000, ['tipo'] = "work" },        
	["polr34"] = { ['name'] = "Nissan Skyline R34 Policia", ['price'] = 800000, ['tipo'] = "work" },        	
	["polgtr"] = { ['name'] = "Nissan Skyline GTR Policia", ['price'] = 800000, ['tipo'] = "work" },        	
	["polgtr50"] = { ['name'] = "Nissan Skyline GTR50 Policia", ['price'] = 800000, ['tipo'] = "work" },      
	["polbmwhz"]  = { ['name'] = "Bmw Boltz Policia", ['price'] = 800000, ['tipo'] = "work" },      	
	["polgt17"] = { ['name'] = "Ford GT17 Policia", ['price'] = 800000, ['tipo'] = "work" }, 
	["cdaraptor"] = { ['name'] = "Raptor Mecânica", ['price'] = 800000, ['tipo'] = "work" }, 
	["scaniarepair"] = { ['name'] = "Guincho", ['price'] = 800000, ['tipo'] = "work" }, 
	["emsrobozao"] = { ['name'] = "R1250 EMS", ['price'] = 800000, ['tipo'] = "work" }, 
	["emsjeep"] = { ['name'] = "Jeep EMS", ['price'] = 800000, ['tipo'] = "work" }, 
}