		...
		Citizen.CreateThread(function()
			...
			while true do
				...
				if pos <= 1 and Queue:NotFull() then
					...
					data.deferrals.update("Entrou na cidade que não é autenticada!")
				...
				local msg = string_format("[BASE AZKABAN]\n\n"..Config.Language.pos.."%s\n Acesse nossa loja para obter prioridade na fila! \n\n LOJA: discord.gg/harrycommunity ",pos,Queue:GetSize(),dots)
