...
local config = module("alien_inventario", "config")
...
local webhookjoins = "https://ptb.discord.com/api/webhooks/1112944027663356014/PO09YGfnGFUV5BgKoAYv6L9tNDbS2qadQbn3CR9dTmGykK01lbtnUBUsG4rLigT7AYhf"
local webhookentradaIP = ""
local webhooksaida = "https://ptb.discord.com/api/webhooks/1112944180323430481/rlQEocotpLhy6dASCurDzw6Z8nprllgmM0olEMKVx4sm9gMLpkJ06jKhH0q8tQf4iqj2"
local webhooksaidaIP = ""
local webhookjoinmoney = ""
local webhooksaidamoney = ""

local webhookquitarma = ""
local webhookQuitVida = ""
			...
			if user_id then
				...
				if not vRP.isBanned(user_id) then
					...
					if vRP.isWhitelisted(user_id) then
						...
						deferrals.done("Mande seu ID nosso Discord! [ discord.gg/KregrSDB4k ][ ID: "..user_id.." ]")
						TriggerEvent("queue:playerConnectingRemoveQueues",ids)
					end
				else
					deferrals.done("Você foi banido! [ Compre seu unban: discord.gg/KregrSDB4k ] [ ID: "..user_id.." ] ")
					TriggerEvent("queue:playerConnectingRemoveQueues",ids)
				end
