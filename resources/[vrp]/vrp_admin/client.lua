...
Citizen.CreateThread( function()
    while not firsthp do
        ...
        local distance = #(coords - vector3(-676.76,314.45,83.09))
        local distance2 = #(coords - vector3(1154.62,-1503.09,36.66))
        if distance <= 20 or distance2 <= 20 and not firsthp then
            firsthp = true
            TriggerEvent('Notify','aviso','Bem vindo ao HP, Utilize <b>/e deitar</b> para se deitar na maca!',10000)
        end
        Citizen.Wait(5000)
    end
end)
...
-----------------------------------------------------------------------------------------------------------------------------------------
--  REMOVER POLICIAIS E NIVEL DE PROCURADO
-----------------------------------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
    for i = 1, 32 do
