...
Config.logo = 'https://i.ibb.co/6vn01vP/d388qpm-cdac4e14-4130-42b5-9fbd-e4c87fb93234-removebg-preview.png'

--[ WEBHOOKS ]--------------------------------------------------------------------------------------------------------------------

Config.webhookCriarBoletim = '---------------------1082549873687150612/VkQ1szql35_98vduksKDFZOihRSmX33LWAdZGYLkmEE_wkbxYG14Lwppt4JMPQECgha0' -- Webhook para criação de boletins;

Config.webhookDelBoletim = '---------------------1082550005807714345/6svYa4Xgs5X31tRgJzszv59pinz-zC-glx90lRUyIcz18D1vRtneMd4YpMKWAdQc8ox0' -- Webhook para o deletamento de boletins de ocorrência;

Config.webhookPrender = '---------------------1082544569348001852/6Suk4U24LzwhZi_5vZ-BPJHMDIonvCrK_IyAPuyIjk8-4b0iAQ88PW40VEDh9XKoupS9' -- Webhook quando um boletim for finalizado e o criminoso preso;

Config.webhookDelCadastro = '---------------------1082549677859295232/qL1uggB6c3yyqwwM90srf71w_SSqWefkBWO7m2mQ46P8awW8Orojp1Wf4n-Yj9-_8ZcI' -- Webhook quando um administrador, deletar um cadastro;

--[ COMANDO ]--------------------------------------------------------------------------------------------------------------------

Config.comandoAbrir = 'tabletpolicia' -- Comando para abrir o Tablet;

--[ PERMISSOES ]--------------------------------------------------------------------------------------------------------------------

Config.permissaoPolicial = 'policia.permissao' -- Permissão para abrir o MDT;

Config.permissaoAdministrativa = 'ac.permissao' -- Permissão que consiguirá acessar a pagina Gerenciar Oficiais;

--[ PRENDER SOMENTE DENTRO DE ZONA ]-------------------------------------------------------------------------------------------------

Config.enablePrenderEmZona = true -- Somente será possível finalizar um boletim dentro de uma zona;

Config.coordenadaZona = vector3(31.71,-923.28,29.91) -- Coodernada da zona;

Config.raioZona = 50 -- Raio da zona;
...
Config.carroCutScene = 'sheriff2' -- Carro em que será spawnado, durante a Cut Scene da prisão;
...
Config.penaMaxima = 60 -- Pena maxima permitida;
