...
config.imgDir = "http://localhost/carros/" -- DIRETORIO DAS IMAGENS DOS VEÍCULOS
...
config.logo = "https://cdn.discordapp.com/attachments/1092376570678747146/1097140005849276456/6bc0e0f99b696e13594b6d623d7b8195-removebg-preview.png" -- LOGO DO SERVIDOR
...
config.openconce_permission = "ac.permissao" -- permissao para abrir a concessionaria

config.updateconce_permission = "ac.permissao" -- permissao para abrir o menu de gerenciamento da conce
...
config.vehList = {
	...
	{ hash = 1094481404, name = 'urus2018', price = 1700000, banido = false, modelo = 'Urus 2018', capacidade = 50, tipo = 'exclusive' },
	...
	{ hash = 1474015055, name = 'r1', price = 1000000, banido = false, modelo = 'Yamaha YZF R1', capacidade = 15, tipo = 'exclusive' },
	...
	{ hash = -2023876491, name = '160', price = 1000000, banido = false, modelo = 'titan 160', capacidade = 30, tipo = 'exclusive' },
	{ hash = -98424359, name = '765lt', price = 1000000, banido = false, modelo = '765lt', capacidade = 40, tipo = 'exclusive' },
	{ hash = 2046572318, name = '911turbos', price = 1000000, banido = false, modelo = '911turbos', capacidade = 40, tipo = 'exclusive' },
	{ hash = -2091594350, name = '918', price = 1000000, banido = false, modelo = '918', capacidade = 40, tipo = 'exclusive' },
	{ hash = 758148345, name = 'a4', price = 1000000, banido = false, modelo = 'a4', capacidade = 40, tipo = 'exclusive' },
	{ hash = -2136030678, name = 'a45amg', price = 1000000, banido = false, modelo = 'a45amg', capacidade = 40, tipo = 'exclusive' },
	{ hash = 1047274985, name = 'africat', price = 1000000, banido = false, modelo = 'africat', capacidade = 15, tipo = 'exclusive' },
  --{ hash = 1093697054, name = 'bmci', price = 1000000, banido = false, modelo = 'bmci', capacidade = 30, tipo = 'exclusive' },
	{ hash = -13524981, name = 'bmwm4gts', price = 1000000, banido = false, modelo = 'bmwm4gts', capacidade = 50, tipo = 'exclusive' },
	{ hash = -1702326766, name = 'corolla', price = 1000000, banido = false, modelo = 'corolla', capacidade = 50, tipo = 'exclusive' },
	{ hash = -1555105668, name = 'fox', price = 1000000, banido = false, modelo = 'fox', capacidade = 30, tipo = 'exclusive' },
	{ hash = 178350184, name = 'g65', price = 1000000, banido = false, modelo = 'g65', capacidade = 50, tipo = 'exclusive' },
	{ hash = 77961676, name = 'gol', price = 1000000, banido = false, modelo = 'gol', capacidade = 50, tipo = 'exclusive' },
	{ hash = -2115506157, name = 'golfmk6', price = 1000000, banido = false, modelo = 'golfmk6', capacidade = 30, tipo = 'exclusive' },
	{ hash = 839941192, name = 'gs1200', price = 1000000, banido = false, modelo = 'gs1200', capacidade = 15, tipo = 'exclusive' },
	{ hash = 1961521335, name = 'gt2rsmr', price = 1000000, banido = false, modelo = 'gt2rsmr', capacidade = 30, tipo = 'exclusive' },
	{ hash = -1371768796, name = 'h2carb', price = 1000000, banido = false, modelo = 'h2carb', capacidade = 15, tipo = 'exclusive' },
	{ hash = 290851400, name = 'hb20', price = 1000000, banido = false, modelo = 'hb20', capacidade = 50, tipo = 'exclusive' },
	{ hash = 539383725, name = 'hiluxsw4', price = 1000000, banido = false, modelo = 'hiluxsw4', capacidade = 30, tipo = 'exclusive' },
	{ hash = -622126799, name = 'jettagli', price = 1000000, banido = false, modelo = 'jettagli', capacidade = 30, tipo = 'exclusive' },
	{ hash = 2034235290, name = 'mazdarx7', price = 1000000, banido = false, modelo = 'mazdarx7', capacidade = 30, tipo = 'exclusive' },
	{ hash = -418486680, name = 'mercedesgt63', price = 1000000, banido = false, modelo = '', capacidade = 35, tipo = 'exclusive' },
	{ hash = 729333126, name = 'mk7', price = 1000000, banido = false, modelo = 'mk7', capacidade = 30, tipo = 'exclusive' },
	{ hash = -694961186, name = 'mobi', price = 1000000, banido = false, modelo = 'mobi', capacidade = 30, tipo = 'exclusive' },
	{ hash = -1621506835, name = 'palio', price = 1000000, banido = false, modelo = 'palio', capacidade = 20, tipo = 'exclusive' },
	{ hash = -217120366, name = 'pcx', price = 1000000, banido = false, modelo = 'pcx', capacidade = 15, tipo = 'exclusive' },
	{ hash = -188978926, name = 'r6', price = 1000000, banido = false, modelo = 'r6', capacidade = 30, tipo = 'exclusive' },
	{ hash = 1934093517, name = 'rmodm5e34', price = 1000000, banido = false, modelo = 'rmodm5e34', capacidade = 40, tipo = 'exclusive' },
	{ hash = 2045784380, name = 'rmodx6', price = 1000000, banido = false, modelo = 'rmodx6', capacidade = 40, tipo = 'exclusive' },
	{ hash = 436874758, name = 's1000rr', price = 1000000, banido = false, modelo = 's1000rr', capacidade = 20, tipo = 'exclusive' },
	{ hash = -301230700, name = 'subaruwrx', price = 1000000, banido = false, modelo = 'subaruwrx', capacidade = 30, tipo = 'exclusive' },
	{ hash = 1747111141, name = 'up', price = 1000000, banido = false, modelo = 'up', capacidade = 50, tipo = 'exclusive' },
	{ hash = -1912535858, name = 'xnsgt', price = 1000000, banido = false, modelo = 'xnsgt', capacidade = 30, tipo = 'exclusive' },
	{ hash = 342059638, name = 'xj6', price = 1000000, banido = false, modelo = 'xj6 turbo', capacidade = 30, tipo = 'exclusive' },
	{ hash = -714386060, name = 'zx10r', price = 1000000, banido = false, modelo = 'zx10r', capacidade = 30, tipo = 'exclusive' },
}
