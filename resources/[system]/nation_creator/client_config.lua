...
spawnCoords = vec3(-93.23, 6410.29, 40.00)
spawnHeading = 333.10
...
function selectCharacter(info)
    if info then
        ...
        TriggerEvent("forcereloadtattos")
...
spawns = {
    { name = "Dream View Motel", coords = {-104.84, 6315.85, 31.58,138.30} },
    { name = "Wonderama Arcade", coords = {1707.15, 4792.02, 41.99,89.00} },
    { name = "The Motor Motel", coords = {1140.97, 2663.99, 38.17,88.30} },
